...
object OpenMockData {
    ...
    fun tiktokShortVideoTab(): TabManifest {
        return tab(
            ...
            sortOrder = 48,
            extraConfig = mapOf(
                "containerType" to "short-video",
                "category" to "leisure",
                "defaultMode" to "native-feed",
                "webHomeUri" to "https://www.tiktok.com/zh-Hans",
                "feedUri" to "",
                "allowedHosts" to "www.tiktok.com,m.tiktok.com,tiktok.com",
                "fallbackAsset" to "short_video_fallback.html",
                "enableNativeDemo" to "true",
                "cachePolicy" to "default"
            )
        )
    }
